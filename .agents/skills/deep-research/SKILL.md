...
3. **Fetch Full Content**: Use the available page-open or fetch tool to read important sources in full, not just snippets
...
### When to Open Full Pages

Open or fetch full content when:
