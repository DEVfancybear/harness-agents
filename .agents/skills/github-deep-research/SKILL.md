...
Multi-round research combining the GitHub API with available web search and page-open tools to produce comprehensive markdown reports.
...
**Round 2 - Discovery (3-5 web searches)**
- Get overview and identify key terms
- Find official website/repo
- Identify main players/competitors

**Round 3 - Deep Investigation (5-10 web searches plus full-page reads)**
- Technical architecture details
- Timeline of key events
- Community sentiment
- Open valuable URLs for full content
...
7. **Extract URLs from search results** - use the result URL, not only its title or snippet
