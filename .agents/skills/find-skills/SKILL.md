...
2. The project-local install command they can run
...
If the user wants to proceed, run the Skills CLI from this project's root to install the skill into `.agents/skills`:
