...
Runbook triển khai; trạng thái: **đã triển khai local, nghiệm thu còn chờ CI remote**. Dự toán: 5–8 ngày công. Target files, Rust tests và lệnh `ha` dưới đây là output tương lai, trừ khi checkout thật đã có. Riêng tài liệu này không là bằng chứng hoàn tất.
