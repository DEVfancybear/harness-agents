...
| Workspace and control | `/diff`, `/undo`, `/trust [yes]`, `/init`, `/permissions [ask|auto-edit|full-auto]` (`/permission`, `/mode`), `/steer <text>`, `/goal <objective>|status|pause|resume|clear` |
