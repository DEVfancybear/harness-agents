...
$notRun = @(
    'PTY cases i01/i05/i06/i07a/i07b/i08/i13: they need a real console, which a sandboxed cargo test does not have. Run scripts/Invoke-HaPtyAcceptance.ps1 - all seven pass there with transcripts; this gate does not count them as passes.',
